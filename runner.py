...
class HotpotQARunner:
    ...
    def _create_search_fn(self, context: Dict[str, List]):
        """
    ...
    def _create_retrieve_fn(self, context: Dict[str, List]):
        """
    ...
    async def run_single_task(
        ...
        search_fn = self._create_search_fn(context)
        retrieve_fn = self._create_retrieve_fn(context)
